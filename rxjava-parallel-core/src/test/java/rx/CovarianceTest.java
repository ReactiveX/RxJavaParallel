...
public class CovarianceTest {
    ...
    public void testCovarianceOfFrom() {
        ParallelObservable.<Movie> from(new HorrorMovie());
        ParallelObservable.<Movie> from(new ArrayList<HorrorMovie>());
    }
...
//        ParallelObservable<Media> o = ParallelObservable.from(new Movie(), new TVSeason(), new Album());
