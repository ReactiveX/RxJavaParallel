...
public abstract class InputWithIncrementingInteger {
    ...
    public ParallelObservable<Integer> observable;
    public ParallelObservable<Integer> firehose;
    public Blackhole bh;
    ...
    public void setup(final Blackhole bh) {
        this.bh = bh;
        observable = ParallelObservable.range(0, getSize());

        firehose = ParallelObservable.create(new OnSubscribe<Integer>() {
